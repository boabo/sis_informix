        ...
        if(exists (	select 1
            ...
            SET
              ...
              tipo_agencia = (case when v_registros.codigo_noiata is null then
                              	...
                              	case when trim (both ' ' from v_registros.idcorni) = 'C' THEN
                                  'corporativa'
                                else
                                  'noiata'
                                end
            ...
            WHERE
              codigo = v_registros.agt::integer::varchar and codigo_noiata is null and codigo_int is null;
            ...
            SET
              ...
              boaagt = TRIM(both ' ' from v_registros.boaagt)
            WHERE
              codigo = v_registros.agt::integer::varchar and (codigo_noiata is not null or codigo_int is not null) and (codigo_noiata = v_registros.codigo_noiata or codigo_int = TRIM(both ' ' from v_registros.codigo_noiata));


        else
        	--insert a la agencia1	º
            INSERT INTO
              obingresos.tagencia
            (
              id_usuario_reg,
            ...
            VALUES (
              ...
              COALESCE(TRIM(both ' ' from v_registros.codigo_noiata),v_registros.agt::integer::varchar),
