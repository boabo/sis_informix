...
BEGIN
   ...
   DROP FOREIGN TABLE IF EXISTS informix.boletos_fpago_modificacion;
    ...
    if (v_detalle is null) then
    	...
    	v_id_alarma = (select param.f_inserta_alarma_dblink (1,'Error al procesar modificaciones de venta web',v_error,'ismael.valdivia@boa.bo,gvelasquez@boa.bo,aldo.zeballos@boa.bo,dcamacho@boa.bo'));
